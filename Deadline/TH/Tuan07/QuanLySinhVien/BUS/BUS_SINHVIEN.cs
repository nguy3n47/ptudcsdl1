...
namespace BUS
{
    public class BUS_SINHVIEN
    {
        ...
        /// <summary>
        /// tiềm kiếm và xuất sinh viên có điểm trung bình lớn nhất hoặc nhỏ nhấti
        /// </summary>
        /// <param name="listSinhVien"></param>
        ...
        public void Select()
        {
            ...
            DTO_SINHVIEN sv = dal_sv.SelectSV(mssv);
            ...
            List<DTO_SINHVIEN> listSV = dal_sv.SelectDSSV(phai);
